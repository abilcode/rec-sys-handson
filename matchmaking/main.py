import pandas as pd
from function.filtering_matchmaking import *

mentor_availability = pd.read_csv("../matchmaking/data/mentor_availability.csv")
mentor_df = pd.read_csv("../matchmaking/data/mentor_interest.csv")
